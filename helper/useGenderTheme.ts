...
export function useGenderTheme() {
  ...
  const config = {
    ...
    heroBannerDesktop: {
      ...
      kids: "/images/banners/kids.png",
    }[gender],
    heroBannerMobile: {
      men: "/home-banner-men-mobile.png",
      women: "/mobile-banner.png",
      kids: "/images/banners/kids_mobile.png",
    }[gender],
    heritageBgDesktop: {
      men: "/heritage-thread-men-bg.png",
      women: "/heritage-thread-bg.png",
      kids: "/heritage-thread-kid-bg.png",
    }[gender],
    heritageBgMobile: {
      men: "/heritage-thread-men-mobile-bg.png",
      women: "/heritage-mobile.png",
      kids: "/heritage-thread-kid-mobile-bg.png",
    }[gender],
    madeforBgDesktop: {
      men: "/madefor-men.png",
      women: "/madefor.png",
      kids: "/madefor-kid.png",
    }[gender],
    madeforBgMobile: {
      men: "/madefor-men-mobile.png",
      women: "/madefor-mobile.png",
      kids: "/madefor-kid-mobile.png",
    }[gender],
    stayConnectedBg: {
      men: "/stay-connected-men.png",
      women: "/stay-connected.png",
      kids: "/stay-connected-kid.png",
    }[gender],
    stayConnectedBgMobile: {
      men: "/stay-connected-men-mobile.png",
      women: "/stayconnected-mobile.png",
      kids: "/stay-connected-kid_mobile.png",
    }[gender],
    heroTitle: {
      men: "MEN Collection",
    ...
    featuredCollections: {
      ...
      kids: [
        { title: "Festive wear", categoryKey: "Kurta Sets", description: "Bright & cheerful patterns for celebration days", image: "/kids-collection-3.png", position: "object-[center_18%]" },
        { title: "Dhoti Sets", categoryKey: "Kurta Sets", description: "Lightweight and easy-breathe designs for active boys", image: "/kids-collection-4.png", position: "object-[center_34%]" },
        { title: "Lehenga Sets", categoryKey: "Ethnic Wear", description: "Sweet details and vibrant colors for girls", image: "/kids-collection-5.png", position: "object-[center_28%]", featured: true },
        { title: "Kurti Sets", categoryKey: "Kurtis", description: "Playful designs for family gatherings", image: "/kids-collection-3.png", position: "object-[center_42%]" },
        { title: "Festive Frocks", categoryKey: "Kurtis", description: "Soft cotton comfort with beautiful print accents", image: "/kids-collection-6.png", position: "object-[center_55%]" },
      ],
      women: [
    ...
    exploreCollections: {
      ...
      kids: [
        { title: "WEDDING EDIT", image: "/kids-explore-collection-3.png", className: "col-span-2 md:col-span-3 min-h-[215px] sm:min-h-[250px]" },
        { title: "FESTIVE COLLECTION", image: "/kids-explore-collection-4.png", className: "col-span-2 md:col-span-3 min-h-[215px] sm:min-h-[250px]" },
        { title: "PARTY WEAR", image: "/kids-explore-collection-5.png", className: "col-span-1 md:col-span-2 min-h-[160px] sm:min-h-[250px]" },
        { title: "EVERYDAY WEAR", image: "/kids-explore-collection-6.png", className: "col-span-1 row-span-2 md:col-span-2 md:row-span-1 min-h-[334px] sm:min-h-[514px] md:min-h-[250px]" },
        { title: "SUMMER COLLECTION", image: "/kids-explore-collection-7.png", className: "col-span-1 md:col-span-2 min-h-[160px] sm:min-h-[250px]" },
      ],
      women: [
    ...
    products: {
      ...
      kids: [
        { name: "Kids' Festive Kurta", slug: "kids-festive-kurta", price: "₹799", image: "/kids-product-1.png", position: "object-[center_18%]" },
        { name: "Kids' Embroidered Lehenga", slug: "kids-embroidered-lehenga", price: "₹1,699", image: "/kids-product-2.png", position: "object-[center_34%]" },
        { name: "Kids' Party Wear Suit", slug: "kids-party-wear-suit", price: "₹1,299", image: "/kids-product-1.png", position: "object-[center_50%]" },
        { name: "Little Prince Sherwani", slug: "little-prince-sherwani", price: "₹1,999", image: "/kids-product-2.png", position: "object-[center_66%]" },
        { name: "Baby Boy Dhoti Set", slug: "baby-boy-dhoti-set", price: "₹999", image: "/kids-product-1.png", position: "object-[center_24%]" },
        { name: "Girls' Floral Anarkali", slug: "girls-floral-anarkali", price: "₹1,199", image: "/kids-product-2.png", position: "object-[center_38%]" },
        { name: "Kids' Festive Kurta 2", slug: "kids-festive-kurta-2", price: "₹799", image: "/kids-product-1.png", position: "object-[center_18%]" },
        { name: "Kids' Embroidered Lehenga 2", slug: "kids-embroidered-lehenga-2", price: "₹1,699", image: "/kids-product-2.png", position: "object-[center_34%]" },
        { name: "Kids' Party Wear Suit 2", slug: "kids-party-wear-suit-2", price: "₹1,299", image: "/kids-product-1.png", position: "object-[center_50%]" },
        { name: "Little Prince Sherwani 2", slug: "little-prince-sherwani-2", price: "₹1,999", image: "/kids-product-2.png", position: "object-[center_66%]" },
      ],
      women: [
